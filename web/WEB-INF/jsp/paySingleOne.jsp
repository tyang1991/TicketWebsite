  ...
  <div class="departDetail">
    <table>
      ...
      <tr>
        ...
        <td>
          <div class="floatTitle">${showItem.value['0'].arriveCode} <b class="arriveTime"><fmt:formatDate value="${showItem.value['0'].arriveTime}" pattern="HH:mm" timeZone="${midZone}"/></b></div>
      ...
      <tr>
        ...
        <td>
          <div class="floatTitle">${showItem.value['1'].departCode} <b class="departTime"><fmt:formatDate value="${showItem.value['1'].departTime}" pattern="HH:mm" timeZone="${midZone}"/> </b></div>
          <div class="minorInfo"><fmt:formatDate value="${showItem.value['1'].departTime}" pattern="EEEEEE"/></div>
        </td>
        <td>
          <div class="floatTitle">${showItem.value['1'].arriveCode} <b class="arriveTime"><fmt:formatDate value="${showItem.value['1'].arriveTime}" pattern="HH:mm" timeZone="${arZone}"/> </b></div>
