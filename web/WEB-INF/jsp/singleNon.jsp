<div class="cell">
  ...
  <div class="right">
    <table class="flightDetail">
      <tr>
        <td>${showItem.value.departCode} <b><fmt:formatDate value="${showItem.value.departTime}" pattern="HH:mm" timeZone="${deZone}"/></b></td>
        <td>${showItem.value.arriveCode} <b><fmt:formatDate value="${showItem.value.arriveTime}" pattern="HH:mm" timeZone="${arZone}"/></b></td>
    ...
    <div class="departDetail">
      <table>
        ...
        <tr>
          ...
          <td>
            <div class="floatTitle">${showItem.value.departCode} <b><fmt:formatDate value="${showItem.value.departTime}" pattern="HH:mm" timeZone="${deZone}"/> </b></div>
            <div class="minorInfo"><fmt:formatDate value="${showItem.value.departTime}" pattern="EEEEEE"/></div>
          </td>
          <td>
            <div class="floatTitle">${showItem.value.arriveCode} <b><fmt:formatDate value="${showItem.value.arriveTime}" pattern="HH:mm" timeZone="${arZone}"/></b></div>
